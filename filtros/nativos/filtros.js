...
myApp.controller('ControladorFiltros', ['$scope', function($scope) {
	$scope.empleados = 
	[
		{
			nombre:'ana',paterno:'guzman',materno:'guzman',primerDia: new Date(),salario:1200000,telefono:'7845648',bono:'1.654'
		},
		{
